...
dis.export(os.path.join('grid',f'grid_offset_{nrow}.shp'))

shutil.copy(os.path.join('gwpath_rasters','starting_location.prj'),os.path.join('grid',f'grid_offset_{nrow}.prj'))
